...
public class ProjectController {
	...
	@RequestMapping(value = "/prj/save/{name}/{course}/{evaluation_done_by}/{submitted_by}/{credits}", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/prj/update/{name}/{course}/{evaluation_done_by}/{submitted_by}/{credits}", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/prj/delete/{name}", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/prj/get/{name}", method = RequestMethod.GET)
